...
@Component
public class OtherTransferProcessMenuHandler_AM extends BaseMenuHandler {
  private static final Logger log = LogManager.getLogger(OtherTransferProcessMenuHandler_AM.class);
