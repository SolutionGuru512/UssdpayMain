package com.bank.ussd.apiclient.otherpayments.handler;

import com.bank.ussd.apiclient.otherpayments.handler.auth.Authentication;
import com.bank.ussd.apiclient.otherpayments.handler.auth.HttpBasicAuth;
import com.bank.ussd.apiclient.otherpayments.handler.auth.OAuth;
...
import com.bank.ussd.apiclient.otherpayments.handler.auth.ApiKeyAuth;


@Component("com.bank.ussd.apiclient.otherpayments.handler.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://172.24.5.17/api/v1.0.0/";
