...
import com.bank.ussd.apiclient.transactions.handler.auth.ApiKeyAuth;
import com.bank.ussd.apiclient.transactions.handler.auth.Authentication;
import com.bank.ussd.apiclient.transactions.handler.auth.HttpBasicAuth;
import com.bank.ussd.apiclient.transactions.handler.auth.OAuth;
...
@Component("com.nibbank.ussd.apiclient.transactions.handler.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://api.temenos.com/api/v1.0.0/";
