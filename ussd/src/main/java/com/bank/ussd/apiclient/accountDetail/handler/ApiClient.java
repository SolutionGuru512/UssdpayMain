package com.bank.ussd.apiclient.accountDetail.handler;

import com.bank.ussd.apiclient.accountDetail.handler.auth.ApiKeyAuth;
import com.bank.ussd.apiclient.accountDetail.handler.auth.Authentication;
import com.bank.ussd.apiclient.accountDetail.handler.auth.HttpBasicAuth;
import com.bank.ussd.apiclient.accountDetail.handler.auth.OAuth;
...
@Component("com.bank.ussd.apiclient.accountDetail.handler.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://192.168.100.21:8888//api/v1.0.0/";
